...
test('should return "Launch!" when passed a number ONLY divisible by 3', () => {
  expect(launchcode.launchOutput(3)).toEqual('Code!');
});
test('should return "Launch!" when passed a number ONLY divisible by 5', () => {
    expect(launchcode.launchOutput(5)).toEqual('Rocks!');
  });
test('should return "Launch!" when passed a number ONLY divisible by 2 and 3', () => {
      expect(launchcode.launchOutput(6)).toEqual('LaunchCode!');
  });
test('should return "Launch Rocks!" when passed a number ONLY divisible by 2 and 5', () => {
